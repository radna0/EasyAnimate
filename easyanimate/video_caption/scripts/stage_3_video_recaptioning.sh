...
MIN_MOTION_SCORE=2
VIDEO_CAPTION_SAVED_PATH="datasets/qbit-downloads_batch/meta_caption_info_vila_8b_$1.jsonl"
REWRITTEN_VIDEO_CAPTION_SAVED_PATH="datasets/qbit-downloads_batch/meta_caption_info_vila_8b_rewritten_$1.jsonl"
VIDEOCLIPXL_SCORE_SAVED_PATH="datasets/qbit-downloads_batch/meta_caption_info_vila_8b_rewritten_videoclipxl_$1.jsonl"
MIN_VIDEOCLIPXL_SCORE=0.20
TRAIN_SAVED_PATH="datasets/qbit-downloads_batch/train_qbit-downloads_$1.json"
