...
VIDEO_CAPTION_SAVED_PATH="datasets/arcane/meta_caption_info_qwen_8b_$1.jsonl"
VIDEOCLIPXL_SCORE_SAVED_PATH="datasets/arcane/meta_caption_info_qwen_8b_rewritten_videoclipxl_$1.jsonl"
MIN_VIDEOCLIPXL_SCORE=0.20
TRAIN_SAVED_PATH="datasets/arcane/train_arcane_$1.json"
