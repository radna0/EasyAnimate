...
export MOTION_SCORE_META_PATH="datasets/qbit-downloads_batch/train_$1.jsonl"
export VIDEO_FRAME_CAPTION_PATH="datasets/qbit-downloads_batch/frame_caption_$1.jsonl"
export VIDEO_CAPTION_PATH="datasets/qbit-downloads_batch/summary_caption_$1.jsonl"
export LAST_JSON_PATH="datasets/qbit-downloads_batch/train_qbit-downloads_$1.json"
